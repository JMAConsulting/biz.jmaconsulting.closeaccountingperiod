...
class CRM_CloseAccountingPeriod_BAO_CloseAccountingPeriod extends CRM_Core_DAO {
   ...
   * @return string
   */
  public static function getTrialBalanceQuery($alias, $onlyFromClause = FALSE, $contactId = NULL, $endDate = NULL, $priorEndDate = NULL) {
    $closingDate = NULL;
...
chapter_to as chapter_code_debit,
fund_to as fund_code_debit,
SUM(debit) as civicrm_financial_trxn_debit,
SUM(credit) as civicrm_financial_trxn_credit,
chapter_from as chapter_code_credit,
fund_from as fund_code_credit,
  {$from}
