 ...
 */
class CRM_CloseAccountingPeriod_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_CloseAccountingPeriod_Upgrader(
        'biz.jmaconsulting.closeaccountingperiod',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_CloseAccountingPeriod_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
